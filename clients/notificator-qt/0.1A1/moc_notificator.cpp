...
QT_MOC_LITERAL(5, 54, 6)
    ...
    "Notificator\0testJSON\0\0handleResult\0"
...
void Notificator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->testJSON(); break;
        case 1: _t->handleResult((*reinterpret_cast< HttpRequestWorker*(*)>(_a[1]))); break;
        default: ;
        }
...
const QMetaObject Notificator::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Notificator.data,
...
void *Notificator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::MainWindow"))
        return static_cast< Ui::MainWindow*>(const_cast< Notificator*>(this));
