...
echo "<input type=\"hidden\" name=\"hostid\" id=\"hostid\" value=\"" . escape(Input::get("host")) . "\">";
	...
	<div class="row">
		<div class="col-md-4">
			<div class="panel panel-primary">
				<div class="panel-heading">Details<div class="pull-right"><span id="refreshData" class="glyphicon glyphicon-refresh btnRefresh" aria-hidden="true"></span></div></div>
		...
		<div class="col-md-8">
			<div class="panel panel-primary">
				<div class="panel-heading">Services<div class="pull-right"><span id="refreshServices" class="glyphicon glyphicon-refresh btnRefresh" aria-hidden="true"></span></div></div>
				<div class="panel-body">
