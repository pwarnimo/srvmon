...
INSERT INTO `tblParent` (`idChild`, `idParent`) VALUES (4,1),(1,2),(6,3),(8,3),(9,3),(3,4),(7,4),(2,5);
...
INSERT INTO `tblServer_has_tblService` (`idServer`, `idService`, `dtValue`) VALUES (1,1,4),(2,1,4),(3,1,4),(4,1,4),(5,1,4),(6,1,4),(7,1,4),(8,1,4),(9,1,4),(6,2,4),(7,2,4),(8,2,4),(9,2,4);
...
INSERT INTO `tblService` (`idService`, `dtCaption`, `dtDescription`, `dtCheckCommand`) VALUES (1,'ping','ICMP ping check','chkping'),(2,'ssh','SSH daemon check','chkssh');
...
-- Dump completed on 2015-04-22 16:56:19
