...
public final class MainFrame extends javax.swing.JFrame {
    ...
    private TrayPanel pnlTray;
    
    private void initNotificator() {
        JOptionPane.showMessageDialog(this, "Please note that this is currently a BETA release.\nThere are still some bugs and errors.\n\nUse this program at your own risk.", "Information", JOptionPane.INFORMATION_MESSAGE);
        ...
        try {
            ...
            //final TrayPanel pnlTray = new TrayPanel();
            
            trayMain.addMouseListener(new MouseAdapter() {
                @Override
                public void mouseClicked(MouseEvent e) {
                    pnlTray.setVisible(!pnlTray.isVisible());
                }
            });
    ...
    private void initComponents() {
        ...
        btnStopRefresh = new javax.swing.JToggleButton();
        ...
        buttonGroup1.add(btnAutoRefresh);
        btnAutoRefresh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/scrubstudios/srvmon/notificator/icons/start-x16.png"))); // NOI18N
        btnAutoRefresh.setText(bundle.getString("MainFrame.btnAutoRefresh.text")); // NOI18N
        ...
        jToolBar1.add(btnAutoRefresh);

        buttonGroup1.add(btnStopRefresh);
        btnStopRefresh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/scrubstudios/srvmon/notificator/icons/pause-x16.png"))); // NOI18N
        btnStopRefresh.setSelected(true);
        btnStopRefresh.setText(bundle.getString("MainFrame.jToggleButton1.text")); // NOI18N
        btnStopRefresh.setFocusable(false);
        btnStopRefresh.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnStopRefresh.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        btnStopRefresh.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnStopRefreshActionPerformed(evt);
            }
        });
        jToolBar1.add(btnStopRefresh);
    ...
    private void mmiConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mmiConnectActionPerformed
        ...
        if (!connected) {
            ...
            if (JOptionPane.showConfirmDialog(this, "Do you really want to connect to a new server?", "Question", JOptionPane.YES_NO_OPTION) == 0) {
                jButton2.doClick();
                jButton1.doClick();
            }
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (connected) {
            ...
            JOptionPane.showMessageDialog(this, "Please connect to a server first.", "Warning", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (connected) {
            ...
            lblDirector.setText("Disconnected");
        }
        else {
            JOptionPane.showMessageDialog(this, "You are already disconnected.", "Information", JOptionPane.INFORMATION_MESSAGE);
        }
        ...
        if (connected) {
            //if (!btnAutoRefresh.isSelected()) {
                ...
                timer.schedule(new TimerTask() {
                    ...
                    public void run() {
                        getCurrentServices();
                        Map<String, ArrayList<Service>> services = getAllFailedServices(serverList);

                        pnlTray.displayServices(services);
            ...
            /*}
                ...
                JOptionPane.showMessageDialog(this, "Autorefresh is already active.", "Information", JOptionPane.INFORMATION_MESSAGE);
            }*/
        }
        else {
            btnStopRefresh.setSelected(true);
    ...
    private void btnStopRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStopRefreshActionPerformed
        if (connected) {
            ...
            JOptionPane.showMessageDialog(this, "Autorefresh is already paused.", "Information", JOptionPane.INFORMATION_MESSAGE);
        }
    }//GEN-LAST:event_btnStopRefreshActionPerformed
    ...
    private javax.swing.JToggleButton btnStopRefresh;
