 ...
 *	*	2015-07-24 : Preparing class for package release.
 *  
 * ### License
 *  
...
class XML {
	 ...
	 *	Generate an error.
	 *		
	 *	This function is used to generate an error which can be interpreted
	 * by the clients.
	 *		
	 *	@param String $action Current action.
	 * @param int $hostid Originating host ID.
	...
	/**
	 * Send offline servers.
	 *		
	 *	This function will send a list of all the servers, which are
	 * currently offline. This function is mainly used by the notificator
	 * or the Android client.
	 *		
	 *	@return String Returns the XML document as string.
	 */
	...
	/**
	 * Send service checksum.
	 *		
	 *	This function will send the checksum for the given service, identified
	 * by its ID.
	 *		
	 *	@param int $hostid Current originating host ID.
	 *	@param int $serviceid ID of the service.
	 *	@return String Returns the SHA1 checksum of the service.
	 */
	 ...
	 * Send a server list.
	 *		
	 *	This function sends a full server list to the caller.
	 *		
	 *	@return String Return the XML document as string.
	 */
	...
	/**
	 * Send all services for a host.
	 *		
	 *	This function creates a list of all services for the given server
	 * and sends it back to the caller.
	 *		
	 *	@param int $hostid ID number of the calling host.
	 *	@return String Returns the XML document as string.
	 */
