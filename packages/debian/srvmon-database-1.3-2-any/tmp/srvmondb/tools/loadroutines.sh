...
FILES=/usr/share/srvmon/sql/stored-procedures/servermgmt/*.sql
...
FILES=/usr/share/srvmon/sql/stored-procedures/servicemgmt/*.sql
...
FILES=/usr/share/srvmon/sql/stored-procedures/settingsmgmt/*.sql
...
FILES=/usr/share/srvmon/sql/stored-procedures/usermgmt/*.sql
