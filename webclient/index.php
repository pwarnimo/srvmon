		...
		<div id="wrapper">
			<div id="sidebar-wrapper">
				<ul class="sidebar-nav">
					<li id="servers" class="norm"><a href="#"><span class="glyphicon glyphicon-tasks"> Servers</span></a></li>
					<li id="services" class="norm"><a href="#"><span class="glyphicon glyphicon-list-alt"> Services</span></a></li>
					<li id="users" class="norm"><a href="#"><span class="glyphicon glyphicon-user"> Users</span></a></li>
					<li id="settings" class="norm"><a href="#"><span class="glyphicon glyphicon-cog"> Settings</span></a></li>
				</ul>
			</div>
